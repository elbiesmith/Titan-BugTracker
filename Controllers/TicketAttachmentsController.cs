...
namespace Titan_BugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Created,Description,UserId,TicketId,FileName,FileData,FileContentType")] TicketAttachment ticketAttachment)
        {
